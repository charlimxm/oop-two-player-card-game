...
describe("Check User Input Date - checkDate()", function() {
  it("should return 3 weekdays", function() {
    assert.equal(index.checkDate(['16 Mar 2009', '17 Mar 2009', '18 Mar 2009']).weekdays, 3)
  })

  it("should return 1 weekday", function() {
    assert.equal(index.checkDate(['20 Mar 2009', '21 Mar 2009', '22 Mar 2009']).weekdays, 1)
  })

  it("should return 2 weekends", function() {
    assert.equal(index.checkDate(['20 Mar 2009', '21 Mar 2009', '22 Mar 2009']).weekends, 2)
  })
})
